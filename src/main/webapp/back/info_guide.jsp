...
<!-- body -->
	...
	<div>
		<form class="form-inline" method="post" action="searchGuide.do">
			<input class="form-control" type="text" name="guide_title" placeholder="请输入指南名称">
...
<div class="row">
	<div class="col-3">
		<div id="myTabs" class="nav nav-pills flex-column" role="tablist">
			...
			<a class="nav-link active" href="showGuide.do" role="tab" >指南信息</a>
	...
	<div class="col-9 ">
		...
		<div>
			<table id="myTable" class="table table-hover">
				...
				<c:forEach items="${guidelist }" var="i" varStatus="gl">
				<tr>
					<td>${i.guideId }</td>
					<td>${i.guideTitle }</td>
					<td>${i.releaseDate }</td>
					<td>${i.guideUrl }</td>
					<td>
						<a class="btn btn-secondary" href="editGuide.do?guide_id=${i.guideId}">修改</a>
						<a class="btn btn-danger" href="deleteGuide.do?guide_id=${i.guideId}" onclick="return deleteOne();">删除</a>
					</td>
				</tr>
				</c:forEach>
			</table>
